/*     Java page for the Context_Source
       - class related to the KPI "delta Abandoned vehicles for the city" 
...
public class DELTA_AV_DISTRICTS {
	...
	public DELTA_AV_DISTRICTS(){
		TS = new String();
		EX = new String();
		this.SCOPE = "DELTA_AV_DISTRICTS";
