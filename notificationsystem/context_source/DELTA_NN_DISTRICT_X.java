/*     Java page for the Context_Source
       - class related to the KPI "delta Noise nuisance for each district" 
...
public class DELTA_NN_DISTRICT_X {
	...
	public DELTA_NN_DISTRICT_X(int circo){
		TS = new String();
		EX = new String();
		this.SCOPE = "DELTA_NN_DISTRICT_"+circo+"";
