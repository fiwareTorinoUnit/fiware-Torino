/*     Java page for the Context_Source
       - class related to the KPI "delta Disturbance from public venues for the city" 
...
public class DELTA_DL_DISTRICTS {
	...
	public DELTA_DL_DISTRICTS(){
		TS = new String();
		EX = new String();
		this.SCOPE = "DELTA_DL_DISTRICTS";
