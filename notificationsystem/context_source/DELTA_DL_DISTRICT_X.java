/*     Java page for the Context_Source
       - class related to the KPI "delta Disturbance from public venues for each district" 
...
public class DELTA_DL_DISTRICT_X {
	...
	public DELTA_DL_DISTRICT_X(int circo){
		TS = new String();
		EX = new String();
		this.SCOPE = "DELTA_DL_DISTRICT_"+circo+"";
	   ...
	   try
         {
			...
			String query_kpi = "select District, Area, ((count(*)-t2.n12)/t2.n12)*100 as delta from view_on_service_request as t1, (select Area as a12, count(*) as n12 from view_on_service_request where Six_Month = \"2013-1\" and Service_Name= \"Disturbance from public venues\" group by Area) as t2  where t1.Area = t2.a12 and Six_Month = \"2013-2\" and Service_Name = \"Disturbance from public venues\" and District="+this.x+" group by Area";
